  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-background text-foreground antialiased">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <a href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <div className="text-xs text-foreground/60">Code Review Dashboard</div>
              </div>
            </a>
            ...
            <nav className="flex items-center gap-6">
              ...
              <a href="/trends" className="text-sm text-foreground/60 hover:text-foreground transition-colors">
                📈 Trends
              </a>
              <a href="/settings" className="text-sm text-foreground/60 hover:text-foreground transition-colors">
                ⚙️ Settings
              </a>
              <a
        ...
        <footer className="border-t border-secondary mt-16 py-6 text-center text-foreground/40 text-sm">
